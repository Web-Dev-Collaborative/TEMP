...
4.  <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLMediaElement/error" class="breadcrumb-current-page"><span data-property="name">HTMLMediaElement.error</span></a>
...
The **`HTMLMediaElement.error`** is the [`MediaError`](https://developer.mozilla.org/en-US/docs/Web/API/MediaError) object for the most recent error, or `null` if there has not been an error. When an `error` event is received by the element, you can determine details about what happened by examining this object.
...
A [`MediaError`](https://developer.mozilla.org/en-US/docs/Web/API/MediaError) object describing the most recent error to occur on the media element or `null` if no errors have occurred.
...
<table><thead><tr class="header"><th>Specification</th><th>Status</th><th>Comment</th></tr></thead><tbody><tr class="odd"><td><a href="https://html.spec.whatwg.org/multipage/#dom-media-error" class="external">HTML Living Standard<br />
<span class="small">The definition of 'HTMLMediaElement.error' in that specification.</span></a></td><td><span class="spec-living">Living Standard</span></td><td></td></tr><tr class="even"><td><a href="https://www.w3.org/TR/html52/embedded-content-0.html#htmlmediaelement" class="external">HTML5<br />
