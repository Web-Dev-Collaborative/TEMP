...
4.  <a href="https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFSender/tonechange_event" class="breadcrumb-current-page"><span data-property="name">RTCDTMFSender: tonechange event</span></a>
...
The **`tonechange`** event is sent to an [`RTCDTMFSender`](https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFSender) by the [WebRTC API](https://developer.mozilla.org/en-US/docs/Web/API/WebRTC_API) to indicate when [DTMF](https://developer.mozilla.org/en-US/docs/Glossary/DTMF) tones previously queued for sending (by calling [`RTCDTMFSender.insertDTMF()`](https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFSender/insertDTMF)) begin and end.

<table><tbody><tr class="odd"><td>Bubbles</td><td>No</td></tr><tr class="even"><td>Cancelable</td><td>No</td></tr><tr class="odd"><td>Interface</td><td><a href="https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFToneChangeEvent"><code>RTCDTMFToneChangeEvent</code></a></td></tr><tr class="even"><td>Event handler property</td><td><a href="https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFSender/ontonechange" title="ontonechange"><code>ontonechange</code></a></td></tr></tbody></table>

To determine what tone started playing, or if a tone stopped playing, check the value of the event's [`tone`](https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFToneChangeEvent/tone "tone") property.
...
This can be done using [`addEventListener()`](https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener "addEventListener()"):
...
You can also just set the [`ontonechange`](https://developer.mozilla.org/en-US/docs/Web/API/RTCDTMFSender/ontonechange "ontonechange") event handler property directly:
