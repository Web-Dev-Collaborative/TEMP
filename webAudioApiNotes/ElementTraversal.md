...
3.  <a href="https://developer.mozilla.org/en-US/docs/Web/API/ElementTraversal" class="breadcrumb-current-page"><span data-property="name">ElementTraversal</span></a>
...
The **`ElementTraversal`** interface used to define methods that allowed access from one [`Node`](https://developer.mozilla.org/en-US/docs/Web/API/Node) to another in the document tree.

It proved useless, as very few types of [`Node`](https://developer.mozilla.org/en-US/docs/Web/API/Node) were able to implement all its methods and properties. It has been split into two interfaces, containing the useful methods and properties for each kind of nodes:
...
<span class="small">The definition of 'ChildNode' in that specification.</span></a></td><td><span class="spec-living">Living Standard</span></td><td>Splitted the <code>ElementTraversal</code> interface in <a href="https://developer.mozilla.org/en-US/docs/Web/API/ParentNode"><code>ParentNode</code></a> and <a href="https://developer.mozilla.org/en-US/docs/Web/API/ChildNode"><code>ChildNode</code></a></td></tr><tr class="even"><td><a href="https://www.w3.org/TR/ElementTraversal/#interface-elementTraversal" class="external">Element Traversal Specification<br />
...
-   [Source on **GitHub**](https://github.com/mdn/content/blob/main/files/en-us/web/api/elementtraversal/index.html "Folder: en-us/web/api/elementtraversal (Opens in a new tab)")
-   [Report a problem with this content on **GitHub**](https://github.com/mdn/content/issues/new?body=MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FElementTraversal%0A%0A%23%23%23%23+What+information+was+incorrect%2C+unhelpful%2C+or+incomplete%3F%0A%0A%0A%23%23%23%23+Specific+section+or+headline%3F%0A%0A%0A%23%23%23%23+What+did+you+expect+to+see%3F%0A%0A%0A%23%23%23%23+Did+you+test+this%3F+If+so%2C+how%3F%0A%0A%0A%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EMDN+Content+page+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fapi%2Felementtraversal%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FElementTraversal%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fapi%2Felementtraversal%2Findex.html%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2F0c31e2bc4d6601a079bc57521e79529539c8cf68%0A*+Document+last+modified%3A+2021-01-20T20%3A24%3A12.000Z%0A%0A%3C%2Fdetails%3E&title=Issue+with+%22ElementTraversal%22%3A+%28short+summary+here+please%29&labels=Content%3AWebAPI%2Cneeds-triage "This will take you to https://github.com/mdn/content to file a new issue")
-   Want to fix the problem yourself? See [our Contribution guide](https://github.com/mdn/content/blob/main/README.md).

**Last modified:** Jan 20, 2021, [by MDN contributors](https://developer.mozilla.org/en-US/docs/Web/API/ElementTraversal/contributors.txt)
...
2.  **[`ElementTraversal`](https://developer.mozilla.org/en-US/docs/Web/API/ElementTraversal)**
