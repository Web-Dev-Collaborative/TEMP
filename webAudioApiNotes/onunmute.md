...
4.  <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/onunmute" class="breadcrumb-current-page"><span data-property="name">MediaStreamTrack.onunmute</span></a>
...
<span class="seoSummary">[`MediaStreamTrack`](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack)'s `onunmute` event handler is called when the `unmute` event is received. Such an event is sent when the track is again able to send data.</span>

When the `onunmute` event handler is called, the track's [`muted`](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/muted "muted") flag is `false`.
...
`unmuteHandler` is a function which is called when the `MediaStreamTrack` receives the `unmute` event. The event handler receives as input a single parameter: an [`Event`](https://developer.mozilla.org/en-US/docs/Web/API/Event) whose <span class="page-not-created">`kind`</span> is `"unmute"`.
...
<table><thead><tr class="header"><th>Specification</th><th>Status</th><th>Comment</th></tr></thead><tbody><tr class="odd"><td><a href="https://w3c.github.io/mediacapture-main/#dom-mediastreamtrack-onunmute" class="external">Media Capture and Streams<br />
...
-   The `unmute` event and its type, [`Event`](https://developer.mozilla.org/en-US/docs/Web/API/Event).
-   [`MediaStreamTrack.muted`](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/muted) to determine if a track is currently muted
-   [`MediaStreamTrack.onmute`](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/onmute), the event handler for the [`MediaStreamTrack.mute_event`](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/mute_event) event.

#### Found a problem with this page?

-   [Source on **GitHub**](https://github.com/mdn/content/blob/main/files/en-us/web/api/mediastreamtrack/onunmute/index.html "Folder: en-us/web/api/mediastreamtrack/onunmute (Opens in a new tab)")
-   [Report a problem with this content on **GitHub**](https://github.com/mdn/content/issues/new?body=MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FMediaStreamTrack%2Fonunmute%0A%0A%23%23%23%23+What+information+was+incorrect%2C+unhelpful%2C+or+incomplete%3F%0A%0A%0A%23%23%23%23+Specific+section+or+headline%3F%0A%0A%0A%23%23%23%23+What+did+you+expect+to+see%3F%0A%0A%0A%23%23%23%23+Did+you+test+this%3F+If+so%2C+how%3F%0A%0A%0A%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EMDN+Content+page+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fapi%2Fmediastreamtrack%2Fonunmute%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FMediaStreamTrack%2Fonunmute%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fapi%2Fmediastreamtrack%2Fonunmute%2Findex.html%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2F5737ba49f3f0c3fc7587d329f1362a7a66afdd80%0A*+Document+last+modified%3A+2021-05-31T16%3A58%3A42.000Z%0A%0A%3C%2Fdetails%3E&title=Issue+with+%22MediaStreamTrack.onunmute%22%3A+%28short+summary+here+please%29&labels=Content%3AWebAPI%2Cneeds-triage "This will take you to https://github.com/mdn/content to file a new issue")
-   Want to fix the problem yourself? See [our Contribution guide](https://github.com/mdn/content/blob/main/README.md).

**Last modified:** May 31, 2021, [by MDN contributors](https://developer.mozilla.org/en-US/docs/Web/API/MediaStreamTrack/onunmute/contributors.txt)
