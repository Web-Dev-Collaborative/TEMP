...
-   [Source on **GitHub**](https://github.com/mdn/content/blob/main/files/en-us/web/api/htmlmodelement/index.html "Folder: en-us/web/api/htmlmodelement (Opens in a new tab)")
