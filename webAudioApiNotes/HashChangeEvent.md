...
3.  <a href="https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent" class="breadcrumb-current-page"><span data-property="name">HashChangeEvent</span></a>
...
*This interface also inherits the properties of its parent, [`Event`](https://developer.mozilla.org/en-US/docs/Web/API/Event).*

[`HashChangeEvent.newURL`](https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent/newURL) <span class="badge inline readonly" title="This value may not be changed.">Read only </span>  
The new URL to which the window is navigating.

[`HashChangeEvent.oldURL`](https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent/oldURL) <span class="badge inline readonly" title="This value may not be changed.">Read only </span>  
The previous URL from which the window was navigated.

[Methods](#methods "Permalink to Methods")
------------------------------------------

*This interface has no methods of its own, but inherits the methods of its parent, [`Event`](https://developer.mozilla.org/en-US/docs/Web/API/Event).*

[Examples](#examples "Permalink to Examples")
---------------------------------------------

### [Syntax options for a hash change](#syntax_options_for_a_hash_change "Permalink to Syntax options for a hash change")
...
There are several fallback scripts listed on the <a href="https://github.com/Modernizr/Modernizr/wiki/HTML5-Cross-Browser-Polyfills" class="external">Modernizr GitHub page</a>. Basically, those scripts check the `hash` property of [`Window.location`](https://developer.mozilla.org/en-US/docs/Web/API/Window/location) at a regular interval. Here is a version that allows only one handler to be bound to the [`onhashchange`](https://developer.mozilla.org/en-US/docs/Web/API/WindowEventHandlers/onhashchange "onhashchange") property:
...
<table><thead><tr class="header"><th>Specification</th><th>Status</th><th>Comment</th></tr></thead><tbody><tr class="odd"><td><a href="https://html.spec.whatwg.org/multipage/#the-hashchangeevent-interface" class="external">HTML Living Standard<br />
...
-   [Source on **GitHub**](https://github.com/mdn/content/blob/main/files/en-us/web/api/hashchangeevent/index.html "Folder: en-us/web/api/hashchangeevent (Opens in a new tab)")
-   [Report a problem with this content on **GitHub**](https://github.com/mdn/content/issues/new?body=MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FHashChangeEvent%0A%0A%23%23%23%23+What+information+was+incorrect%2C+unhelpful%2C+or+incomplete%3F%0A%0A%0A%23%23%23%23+Specific+section+or+headline%3F%0A%0A%0A%23%23%23%23+What+did+you+expect+to+see%3F%0A%0A%0A%23%23%23%23+Did+you+test+this%3F+If+so%2C+how%3F%0A%0A%0A%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EMDN+Content+page+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fapi%2Fhashchangeevent%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FHashChangeEvent%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fapi%2Fhashchangeevent%2Findex.html%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2Fcb20a8045f6cbdbd224b1068e46c8644470dd8c3%0A*+Document+last+modified%3A+2021-06-01T09%3A10%3A31.000Z%0A%0A%3C%2Fdetails%3E&title=Issue+with+%22HashChangeEvent%22%3A+%28short+summary+here+please%29&labels=Content%3AWebAPI%2Cneeds-triage "This will take you to https://github.com/mdn/content to file a new issue")
-   Want to fix the problem yourself? See [our Contribution guide](https://github.com/mdn/content/blob/main/README.md).

**Last modified:** Jun 1, 2021, [by MDN contributors](https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent/contributors.txt)
...
1.  **[`HashChangeEvent`](https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent)**
2.  Properties
    1.  [`newURL`](https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent/newURL)
    2.  [`oldURL`](https://developer.mozilla.org/en-US/docs/Web/API/HashChangeEvent/oldURL)
3.  Inheritance:
